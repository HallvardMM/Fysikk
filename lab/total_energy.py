...
x_values_1 = np.genfromtxt(
    "./data/1_data.txt", delimiter=";", skip_header=2, usecols=1)
x_values_2 = np.genfromtxt(
    "./data/2_data.txt", delimiter=";", skip_header=2, usecols=1)
x_values_3 = np.genfromtxt(
    "./data/3_data.txt", delimiter=";", skip_header=2, usecols=1)
x_values_4 = np.genfromtxt(
    "./data/4_data.txt", delimiter=";", skip_header=2, usecols=1)
x_values_5 = np.genfromtxt(
    "./data/5_data.txt", delimiter=";", skip_header=2, usecols=1)
x_values_6 = np.genfromtxt(
    "./data/6_data.txt", delimiter=";", skip_header=2, usecols=1)
x_values_7 = np.genfromtxt(
    "./data/7_data.txt", delimiter=";", skip_header=2, usecols=1)
x_values_8 = np.genfromtxt(
    "./data/8_data.txt", delimiter=";", skip_header=2, usecols=1)
x_values_9 = np.genfromtxt(
    "./data/9_data.txt", delimiter=";", skip_header=2, usecols=1)
x_values_10 = np.genfromtxt(
    "./data/10_data.txt", delimiter=";", skip_header=2, usecols=1)


y_values1 = np.genfromtxt(
    "./data/1_data.txt", delimiter=";", skip_header=2, usecols=2)
v1 = np.genfromtxt("./data/1_data.txt", delimiter=";",
                   skip_header=2, usecols=5)
y_values2 = np.genfromtxt(
    "./data/2_data.txt", delimiter=";", skip_header=2, usecols=2)
v2 = np.genfromtxt("./data/2_data.txt", delimiter=";",
                   skip_header=2, usecols=5)
y_values3 = np.genfromtxt(
    "./data/3_data.txt", delimiter=";", skip_header=2, usecols=2)
v3 = np.genfromtxt("./data/3_data.txt", delimiter=";",
                   skip_header=2, usecols=5)
y_values4 = np.genfromtxt(
    "./data/4_data.txt", delimiter=";", skip_header=2, usecols=2)
v4 = np.genfromtxt("./data/4_data.txt", delimiter=";",
                   skip_header=2, usecols=5)
y_values5 = np.genfromtxt(
    "./data/5_data.txt", delimiter=";", skip_header=2, usecols=2)
v5 = np.genfromtxt("./data/5_data.txt", delimiter=";",
                   skip_header=2, usecols=5)
y_values6 = np.genfromtxt(
    "./data/6_data.txt", delimiter=";", skip_header=2, usecols=2)
v6 = np.genfromtxt("./data/6_data.txt", delimiter=";",
                   skip_header=2, usecols=5)
y_values7 = np.genfromtxt(
    "./data/7_data.txt", delimiter=";", skip_header=2, usecols=2)
v7 = np.genfromtxt("./data/7_data.txt", delimiter=";",
                   skip_header=2, usecols=5)
y_values8 = np.genfromtxt(
    "./data/8_data.txt", delimiter=";", skip_header=2, usecols=2)
v8 = np.genfromtxt("./data/8_data.txt", delimiter=";",
                   skip_header=2, usecols=5)
y_values9 = np.genfromtxt(
    "./data/9_data.txt", delimiter=";", skip_header=2, usecols=2)
v9 = np.genfromtxt("./data/9_data.txt", delimiter=";",
                   skip_header=2, usecols=5)
y_values10 = np.genfromtxt(
    "./data/10_data.txt", delimiter=";", skip_header=2, usecols=2)
v10 = np.genfromtxt("./data/10_data.txt", delimiter=";",
                    skip_header=2, usecols=5)
